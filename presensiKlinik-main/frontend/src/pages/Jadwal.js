...
class JadwalKehadiran extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (dataExists) {
      ...
      axios
        .post(this.state.urlDb + "/jadwal/add/", postData)
        .then((response) => {
          Swal.fire({
            icon: "success",
            title: "Berhasil",
  ...
  getPegawai = () => {
    axios
      .get(this.state.urlDb + "/pegawai/data/")
      .then((response) => {
  ...
  getJadwal = (tahun) => {
    ...
    axios
      .post(this.state.urlDb + "/jadwal/data/", postData)
      .then((response) => {
  ...
  handleDelete = (idJadwal) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${this.state.urlDb}/jadwal/delete/${idJadwal}`)
          .then((response) => {
            Swal.fire({
              icon: "success",
              title: "Berhasil",
  ...
  handleUpdate = (e) => {
    ...
    axios
      .post(this.state.urlDb + "/jadwal/edit/", postData)
      .then((response) => {
        Swal.fire({
          icon: "success",
          title: "Berhasil",
