...
class DataPegawai extends Component {
  ...
  handleSubmit = (e) => {
    ...
    axios
      .post(this.state.urlDb + "/pegawai/add-pegawai/", postData)
      .then((response) => {
        Swal.fire({
          icon: "success",
          title: "Berhasil",
  ...
  handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${this.state.urlDb}/pegawai/delete-pegawai/${id}`)
          .then((response) => {
            Swal.fire({
              icon: "success",
              title: "Berhasil",
  ...
  handleUpdate = (e) => {
    ...
    axios
      .post(this.state.urlDb + "/pegawai/update-pegawai/", postData)
      .then((response) => {
        Swal.fire({
          icon: "success",
          title: "Berhasil",
