...
class DetailJadwal extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (dataExists) {
      ...
      axios
        .post(this.state.urlDb + "/detail-jadwal/add/", postData)
        .then((response) => {
          Swal.fire({
            icon: "success",
            title: "Berhasil",
  ...
  getDetailJadwal = () => {
    ...
    // alert("jalan");
    axios
      .post(this.state.urlDb + "/detail-jadwal/", postData)
      .then((response) => {
  ...
  getJadwal = () => {
    ...
    axios
      .post(this.state.urlDb + "/jadwal/data/detail/", postData)
      .then((response) => {
  ...
  handleDelete = (idDetail) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(this.state.urlDb + `/detail-jadwal/delete/${idDetail}`)
          .then((response) => {
            Swal.fire({
              icon: "success",
              title: "Berhasil",
  ...
  handleUpdate = (e) => {
    ...
    axios
      .post(this.state.urlDb + "/detail-jadwal/edit/", postData)
      .then((response) => {
        Swal.fire({
          icon: "success",
          title: "Berhasil",
