...
class RekapKehadiranApoteker extends Component {
  ...
  getData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-apoteker/get`,
        arg,
        {
          headers: {
  ...
  deleteData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-apoteker/delete`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  ambilData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-apoteker/cek`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  handleExport = (e) => {
    ...
    this.downloadCSV(
      csvContent,
      `Usulan Uang Transport Apoteker ${this.state.bulan} ${this.state.tahun}.csv`
    );
    ...
    this.downloadCSV(
      csvContent2,
      `Data Rekap Kehadiran Apoteker ${this.state.bulan} ${this.state.tahun}.csv`
    );
  };
