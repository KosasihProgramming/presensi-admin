...
class RekapKehadiranPerawat extends Component {
  ...
  getData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat/get`,
        arg,
        {
          headers: {
  ...
  deleteData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat/delete`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  ambilData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat/cek`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  getDataKomisi = async (tanggal, barcode) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat/get-insentif`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
