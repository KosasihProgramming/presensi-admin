...
class RekapKehadiranDokter extends Component {
  ...
  getData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-dokter/get`,
        arg,
        {
          headers: {
  ...
  deleteData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-dokter/delete`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  ambilData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-dokter/cek`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  getDataKomisi = async (tanggal, barcode) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-dokter/get-insentif`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
