...
class RekapKehadiranPerawatGigi extends Component {
  ...
  getData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat-gigi/get`,
        arg,
        {
          headers: {
  ...
  deleteData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat-gigi/delete`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  ambilData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat-gigi/cek`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  getDataKomisi = async (tanggal, barcode) => {
    const arg = { tanggal, barcode };

    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-perawat-gigi/get-insentif`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
