...
class RekapKehadiranFarmasi extends Component {
  ...
  getData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-farmasi/get`,
        arg,
        {
          headers: {
  ...
  deleteData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-farmasi/delete`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  ambilData = async (bulan, tahun) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-farmasi/cek`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  getDataKomisi = async (tanggal) => {
    ...
    try {
      const response = await axios.post(
        `${this.state.urlDb}/rekap-kehadiran-farmasi/get-insentif`,
        arg,
        {
          headers: {
            "Content-Type": "application/json",
